...
\Exercise{28} Prove that every closed set in a separable metric space
...
\Exercise{29} Prove that every open set in $R^1$ is the union of an at
most countable collection of disjoint segments.
\label{exercise:basic-topology:open-sets-in-R1-union-of-segments}
\begin{proof}
...
\Exercise{30} Imitate the proof of Theorem~2.43 to obtain the
following result:
\begin{quote}
